...
class MapStep(Step):
    def map_roster(self, root: Element):
        rosters = root.findall("{http://service.jcms.jeppesen.com/RosterStateOutput/v5.1}roster")
        crew_members = []
        ...
        for roster in rosters:
            ...
            crew.name = f"{roster.attrib.get('givenName')} {roster.attrib.get('surName')}"
            crew.rank = roster.attrib.get("rank")
